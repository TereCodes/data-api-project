                ...
                <div className="data-grid">
                    {data.map((item, index) => (
                        ...
                        className="data-list">
                            ...
                            <p className="open-crawl">{reduceLength(item.opening_crawl, 260)}</p>
